...
namespace ZZZ.KNI.GameProject
{
    ...
    internal class TestComponent : Framework.Component, IStartupComponent, IUpdateComponent, IRender, IStopComponent
    {
        ...
        {
            renderManager.DrawLine(raycastResult.Start, raycastResult.Point, Color.Red, 1f);
        }
        ...
        void IUpdateComponent.Update(GameTime gameTime)
        {
            ...
            raycastResult = WorldRegistrar.Raycast(pos, pos + Mouse.GetState().Position.ToVector2() - new Vector2(400, 240), ColliderLayer.Cat2);
