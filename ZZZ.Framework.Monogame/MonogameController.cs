...
{
    public interface IMonogameController : IRegistrar, IGameComponent, IDrawable, IUpdateable
    {
        Game Game { get; internal set; }
    }

    public abstract class MonogameController<TComponent> : Registrar<TComponent>, IMonogameController
        where TComponent : class, IComponent
    {
        ...
        Game IMonogameController.Game { get => Game; set => Game = value; }
