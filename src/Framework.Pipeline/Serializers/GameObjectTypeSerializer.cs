...
//            var containers = input.ReadObject<IEnumerable<GameObject>>(new ContentSerializerAttribute() { ElementName = "Childs" });
...
//            output.WriteObject(value.GetGameObjects(), new ContentSerializerAttribute() { ElementName = "Childs" });
//        }
//    }
//}
