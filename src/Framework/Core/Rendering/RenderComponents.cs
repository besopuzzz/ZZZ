...
//{
//    internal sealed class RenderComponents
//    {
...
//            if (component.Layer == (SortLayer)Layer)
...
//        {
//            if (e.OldLayer == (SortLayer)Layer)
//                Components.Remove((IRender)sender);

//            if (e.NewLayer == (SortLayer)Layer)
